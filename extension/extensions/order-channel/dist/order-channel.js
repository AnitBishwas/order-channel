(() => {
  ...
  // extensions/order-channel/src/ActionExtension.jsx
  ...
  function useRender() {
    const render2 = (0, import_react4.useContext)(RenderContext);
    if (render2 == null) {
  ...
  function reactExtension(target, render2) {
    return extension(target, (root, api) => __async(this, null, function* () {
      ...
      const element = yield render2(api);
  ...
  var TARGET = "admin.order-index.action.render";
...
//# sourceMappingURL=order-channel.js.map
